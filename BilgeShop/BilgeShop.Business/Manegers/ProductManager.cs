...
namespace BilgeShop.Business.Manegers
{
    public class ProductManager : IProductService
    {
        ...
        {
            var entitiy = _productRepository.GetById(id);
            var updateProductDto = new UpdateProductDto()
            {
                ...
                UnitsInStock = entitiy.UnitsInStock,
                UnitPrice = entitiy.UnitPrice,
                CategoryId = entitiy.CategoryId,
