...
namespace BilgeShop.Business.Manegers
{
    public class UserManager : IUserService
    {
        ...
        public ServiceMessage AddUser(AddUserDto addUserDto)
        {
            ...
            ///eklenilmek  istenen mail adresi ile  veri tabanında zaten bulunana verilerin tamamını çekiyorum  null gelirse eklenebilir  null değilse zaten o kullanıcı adı mevcut
            ///
            ...
            if(hasMail.Any())///hasMail is not null /hasMail.count !=0
            {
                ...
                {
                    IsSucceed = false,
                    Message = "bu e posta adresli bir kullanıcı zaten mevcut"
                };
